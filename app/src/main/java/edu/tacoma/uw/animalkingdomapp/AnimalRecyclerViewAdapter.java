...
import edu.tacoma.uw.animalkingdomapp.databinding.FragmantAnimalBinding;
...
public class AnimalRecyclerViewAdapter extends
    ...
    public AnimalRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater
                ...
                .inflate(R.layout.fragmant_animal, parent, false ));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public FragmantAnimalBinding binding;
        public Animal mItem;

        public ViewHolder(View view) {
            super(view);
            mView = view;
            binding = FragmantAnimalBinding.bind(view);
        }

        public void setItem(final Animal item) {
            mItem = item;
            binding.animalId.setText(Integer.valueOf(item.getId()).toString());
            binding.animalName.setText(item.getnName());
